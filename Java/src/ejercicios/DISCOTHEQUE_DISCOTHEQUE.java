...
public class DISCOTHEQUE_DISCOTHEQUE {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            int[][] matriu = JCllenarmatriz(filas, cols, sc);

            int x = sc.nextInt(); 
            int y = sc.nextInt();
            int k = sc.nextInt();

            if (!esticDins(x, y, matriu)) {
                System.out.println("La casella no es valida");
            } else {
                String enemics = "OK";
                    ...
                    for (int dy = -1; dy <= 1; dy++) {
                        if ((dx == 0 && dy == 0)) {
                            ...
                            if(count == count2) {
                            	...
                            	enemics = "DISCOTHEQUE, DISCOTHEQUE";
                            }
                        }
                    }
                }
